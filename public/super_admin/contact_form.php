...
<div class="content">
	<div class="page-header">
		<ol class="breadcrumb">
			...
			<li class="active">All Contact List</li>
		</ol>
	</div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body table-responsive">
						...
						if (isset($_POST["complete"])) {
							$bill = $_POST['id'];
							$result = mysqli_query($link, "delete from tbl_contact_form where id=$bill ");
							if ($result) {
						?>
						...
						<table id="example0" class="table display">
							...
							<tbody>
								<?php
								$result = mysqli_query($link, "select * from tbl_contact_form order by id desc");
								$i = 0;
								...
								?>
									<tr>
										...
										<td>
<!-- 
											<a href="edit_contact.php?id=<?= $row['id']; ?>" class="btn btn-icon btn-xs btn-success mr-1">
												Edit
											</a> -->
