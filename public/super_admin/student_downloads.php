...
<div class="content">
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="active">All Student Downloads</li>
        </ol>
    </div>
    <div class="container-padding container-widget">
        ...
        <div class="row">
                    ...
                    <div class="panel-body">
                        ...
                        ?>
                                ...
                                <?php
                                    ...
                                    @move_uploaded_file($filetmp1, "../uploads/stu_down/" . $ran . date("Y-m-d") . '.' . $imageFileType1["extension"]);
                                    $filepath2 = "../uploads/stu_down/" . $ran . date("Y-m-d") . '.' . $imageFileType1["extension"];
                                }
                            }

                            $queryy = "insert into tbl_stu_down (title,file) values('$title','$filepath2')";
                            //echo $queryy;
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-title">
                        All Student Downloads
                    </div>
                    <div class="panel-body table-responsive">
                        <?php
                        if (isset($_POST["delete"])) {
                            $bill = $_POST['id'];
                            $sql = "DELETE FROM tbl_stu_down WHERE id=$bill";
                        ...
                        <table id="example0" class="table display">
                            ...
                            <tbody>
                                <?php
                                $result = mysqli_query($link, "select * from tbl_stu_down order by id desc");
                                $i = 0;
