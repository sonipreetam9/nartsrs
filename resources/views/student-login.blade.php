...
@section('title', 'Student Login - NART')
@section('description', 'Sign in to your NART account to access your dashboard.')
                        ...
                        <div class="login-card">
                            <div class="row g-0">
                                ...
                                <div class="col-lg-5 col-md-6 login-image-side">
                                    <div class="login-image-overlay">
                                        <img src="{{ asset('assets/images/NART-white.webp') }}" alt="NART Logo"
                                            style="max-height: 100px; border-radius:10px; margin-bottom: 30px;" />
                                        <h2>Welcome Back!</h2>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-7 col-md-6 login-form-side">
                                    ...
                                    <div>
                                        <h3 class="ed-auth__title">Student Sign In</h3>
                                        <p class="ed-auth__text">Please enter your credentials to proceed.</p>
                                    </div>

                                    <form action="{{ route('student.login.post') }}" method="POST" class="ed-auth__form">
                                        @csrf
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text"
                                                ...
                                                name="DOB" value="{{ old('DOB') }}" placeholder="Date of Birth (e.g. 01-01-1990)" required />
                                            @error('DOB')
                                                <span class="text-danger"
                                                    style="font-size:13px; margin-top:5px; display:block; font-weight: 500;">
                                                    <i class="fi fi-rr-info"></i> {{ $message }}
                                        ...
                                        <div class="ed-auth__form-btn">
                                            <button type="submit" class="ed-btn-modern">
                                                Sign In <i class="fi fi-rr-arrow-small-right"></i>
                                            </button>
                                        </div>
